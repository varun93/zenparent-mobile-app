...
class PopularPostsContainer extends Component{
	...
	render(){
		...
		return (
			<div>
				<PostsCarousel position="210" title="Popular Posts" toggleLike={this.props.toggleLike} toggleBookmark={this.props.toggleBookmark}  posts={posts} navigator={this.props.navigator} />
			</div>
		);
