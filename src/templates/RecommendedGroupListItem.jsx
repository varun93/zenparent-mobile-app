    ...
    return (
        <div className="card" onClick={(event) => { joinChatroom(item.post_id); navigator.pushPage({component: Chatroom,props : {chatroomId : item.post_id}}); }}>
          <Row>
            ...
            <Col style={{padding: "8px 0px 0px 20px"}} width="65%">
            ...
            <Col verticalAlign="center" style={{margin : "-5px 0px",position:"relative",height:"60px",background:"rgb(132,116,159)",color:"white",fontWeight:"bold",textAlign:"center"}} verticalAlign="center" width="25%">
